...
- [Pi、Codex、DeepSeek Harness 上下文管理对比](agent-context-management-pi-codex-deepseek-2026-08-25.md)：用于 durable Transcript、derived context surface、Context Manifest、Provider Continuity Vault、compaction 与 Long-Run Retrieval；CM-0—CM-4 Planning machine slice 已实现，真实音乐 Tool 的长 Run 质量仍待后续纵切。
