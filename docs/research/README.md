...
- [Pi、Codex、DeepSeek Harness 上下文管理对比](agent-context-management-pi-codex-deepseek-2026-08-25.md)：用于 durable Transcript、derived context surface、Context Manifest、Provider Continuity Vault、compaction 与必做的 Long-Run Retrieval 实施切片；CM-0/CM-1/CM-2 Planning slice 已实现，CM-3 checkpoint foundation 正在实施，CM-4 未实现。
